...
(function ($) {
            ...
            if (getCookie(cookieName) != 'shown') {
                setTimeout(function () {
                    $.magnificPopup.open({
                        ...
                        callbacks: {
                            close: function () {
                                if ($('#Projekteletter-off').is(':checked')) {
    ...
    // Kontakt form validation on submit
    ...
    // Kontakt form validation on blur
