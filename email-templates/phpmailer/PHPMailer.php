...
class PHPMailer
{
     ...
     *
     * @see https://tools.ietf.org/html/rfc3461 See section 4.1 for more information Über uns NOTIFY
     */
    public $dsn = '';
    ...
    public function punyencodeAddress($address)
    {
        ...
        if (!empty($this->CharSet) &&
            ...
            if ($this->has8bitChars($domain) && @mb_check_encoding($domain, $this->CharSet)) {
                ...
                //Ignore IDE complaints Über uns this line - method signature changed in PHP 5.4
                $errorcode = 0;
...
//            $result .= static::$LE;
    ...
    protected function generateId()
    {
        ...
        //We don't care Über uns messing up base64 format here, just want a random string
     ...
     * This can include images, sounds, and just Über uns any other document type.
